    ...
    public void fillHipoEventAHDC(Event hipoEvent, EvioDataEvent evioEvent){
        if(evioEvent.hasBank("AHDC::dgtz")){
            ...
            for(int i = 0; i < evioBank.rows(); i++){
                ...
                hipoTDC.putShort("wire", i,  (short) evioBank.getInt("wire",i));
                hipoTDC.putFloat("doca", i,  (float) evioBank.getDouble("doca", i));
                hipoTDC.putFloat("adc", i,  (float) evioBank.getDouble("adc",i));
            }
